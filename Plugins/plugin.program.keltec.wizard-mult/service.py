...
def save_menu():
	save_items = []
	choices = ["Favouritos", "Fuentes", "Debrid - Resolve URL", "Advanced Settings"]
	dialog = xbmcgui.Dialog()
	save_select = dialog.multiselect(addon_name + "[COLOR lime] - Seleccionar elementos a guardar[/COLOR]",choices, preselect=[])
